...
int addFileToArchive(struct archive* write, NSString* filePath, NSString* basePath, NSProgress* progress) {
	...
	// relativePath = [relativePath stringByReplacingOccurrencesOfString:@"GDbe.dimisaio.dindegdps22.app" withString:@"GeodeHelper.app"];
	relativePath = [relativePath stringByReplacingOccurrencesOfString:@"GDbe.dimisaio.dindegdps22.app" withString:@"GeometryJump.app"];
